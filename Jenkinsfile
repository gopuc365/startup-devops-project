            ...
            steps {
                ...
                withCredentials([string(credentialsId: 'GitHub_Token', variable: 'github_token')]) {
                    ...
                    checkout([
                        ...
                        userRemoteConfigs: [[url: 'https://' + env.github_token + '@' + 'github.com/gopuc365/startup-devops-project.git']] // The repository URL with the GitHub token for authentication.
                    ])
                }
            }
        }
